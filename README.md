...
<p align="center">
  <em>One local corpus, July 2026: 20.8K sessions, 782K facts. Across 10,015
  paired Codex sessions: 2.92B raw tokens → 45.4M transcript tokens (64.4x
  smaller). Search: 12 ms median; 25.8M raw tokens → 51.8K transcript tokens in
  1.43 s.</em>
</p>
