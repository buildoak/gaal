...
| 3 | NotFound | Session reference does not exist in index | Verify the full ID, unique prefix, or registered alias. May need `gaal index backfill` if the session is recent |
