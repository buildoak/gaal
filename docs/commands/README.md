...
| [`gaal resolve`](self-id.md) | Resolve a full ID, unique prefix, registered alias, or `latest` to source and artifact paths. |
...
| Command | Use |
| --- | --- |
| [`gaal recall`](search-recall.md) | Retrieve generated handoffs by topic or direct session reference. |
