...
## I5: `gaal active -H` outputs JSON instead of table [FIXED 2026-03-09] [OBSOLETE 2026-03-14]

[OBSOLETE 2026-03-14] — command deleted in v0.1.0; process monitoring discontinued permanently.
...
## I7: `gaal handoff <id>` — silent freeze during processing [FIXED 2026-03-09] [FIXED 2026-03-14]

[FIXED 2026-03-14] — eprintln progress messages added to handoff pipeline before LLM call.
...
## I6: `gaal active` stuck detection — false positives + config inconsistency [FIXED 2026-03-09] [OBSOLETE 2026-03-14]

[OBSOLETE 2026-03-14] — command deleted in v0.1.0; stuck detection removed permanently.
...
## I9: `gaal active` can't find API-spawned Codex sessions [FIXED 2026-03-09] [OBSOLETE 2026-03-14]
...
## I10: `gaal handoff` extracts wrong session boundary — child instead of parent [FIXED 2026-03-09] [OBSOLETE 2026-03-14]

[OBSOLETE 2026-03-14] — parent-child linking purged in v0.1.0; feature removed permanently (1 of 2,433 sessions ever linked).
...
## I11: Parent-child session linking is nearly dead — linker rarely fires [FIXED 2026-03-09] [OBSOLETE 2026-03-14]

[OBSOLETE 2026-03-14] — parent-child linking purged in v0.1.0; linker.rs and link-parents command deleted.
...
## I16: `gaal show` returns "not found" for current running session [FIXED 2026-03-10] [OBSOLETE 2026-03-14]

[OBSOLETE 2026-03-14] — show.rs deleted in v0.1.0; functionality merged into gaal inspect.
...
## I18: `gaal ls` shows all sessions as "completed" [FIXED 2026-03-10] [OBSOLETE 2026-03-14]

[OBSOLETE 2026-03-14] — status system (SessionStatus enum) removed entirely in v0.1.0; no status field to be wrong.
...
## I19: `gaal active` false positive stuck detection [FIXED 2026-03-10] [OBSOLETE 2026-03-14]
...
## I20: `gaal active` lacks session summary — unclear what each session is doing [FIXED 2026-03-10] [OBSOLETE 2026-03-14]
...
## I21: `gaal active` needs first-principles rethink — mixed session types, subagent noise [FIXED 2026-03-10] [OBSOLETE 2026-03-14]

[OBSOLETE 2026-03-14] — command deleted in v0.1.0; decided to remove rather than fix.
...
## I22: Active session detection logic — overfitted vs generalizable [CLOSED 2026-03-11] [OBSOLETE 2026-03-14]

[OBSOLETE 2026-03-14] — command deleted in v0.1.0; active session detection architecture moot.
...
## I23: `gaal show` with no parameters shows random session [REMOVED v0.1.0] [OBSOLETE 2026-03-14]
...
## I24: `gaal show <id>` not-found for sessions listed in `gaal active` [FIXED 2026-03-10] [OBSOLETE 2026-03-14]

[OBSOLETE 2026-03-14] — both gaal show and gaal active deleted in v0.1.0.
...
## I25: Default gaal outputs are too token-heavy for agent consumption [FIXED 2026-03-14]

[FIXED 2026-03-14] — covered by I34 (ls default limit → 10), I38 (who JSON grouped/brief), and I36 (show merged into inspect with concise defaults).
...
## I28: `gaal active` shows duplicate entries for same session ID [FIXED 2026-03-10] [OBSOLETE 2026-03-14]
...
## I29: `gaal active` lists child `codex exec` workers as independent sessions [FIXED 2026-03-10] [OBSOLETE 2026-03-14]
...
## I30: `gaal active` shows ghost sessions — pid=0, no live process [FIXED 2026-03-10] [OBSOLETE 2026-03-14]
...
## I31: `gaal active` dedup still not working — same session appears multiple times [FIXED 2026-03-10] [OBSOLETE 2026-03-14]
...
## I32: `gaal active` stuck detection still wrong — active sessions flagged as stuck [FIXED 2026-03-10] [OBSOLETE 2026-03-14]
...
## I33: `gaal active` context% wrong — 0% for Claude, 121% for Codex [FIXED 2026-03-10] [OBSOLETE 2026-03-14]
...
## I34: `gaal ls` default limit too high — floods output [FIXED 2026-03-14]

[FIXED 2026-03-14] — default limit changed from 50 to 10 in src/main.rs.
...
## I36: `gaal show -H` still too token-heavy — bypasses summary card [REMOVED v0.1.0] [OBSOLETE 2026-03-14]

[OBSOLETE 2026-03-14] — show.rs deleted in v0.1.0; functionality merged into gaal inspect with concise defaults.
...
## I37: `gaal active` — 3 PIDs dedup bug collapses distinct sessions [OBSOLETE 2026-03-14]
...
## I42: `gaal who` verb help text — `touched` and `changed` are unclear [FIXED 2026-03-14]

[FIXED 2026-03-14] — full verb table added to gaal who --help and invalid-verb error messages.
...
3. **Subagent JSONL not indexed:** Many file operations happened in Claude Code subagent sessions stored under `~/.claude/projects/<hash>/<session>/subagents/agent-*.jsonl`. The discovery function `collect_project_jsonl_files()` in `src/discovery/claude.rs` only scans one level deep (`<hash>/*.jsonl`), missing all subagent files two levels deeper. [CLOSED 2026-03-14] — Claude Code sessions already include subagent traces in the main JSONL; separate subagent file indexing not needed.
